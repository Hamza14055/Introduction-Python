...
label1=Label(root,text="Hey User Welcome to Denomination Counter",bg="light blue")
label1.place(relx=0.5,y=340,anchor=CENTER)
def msg():
    MsgBox = messagebox.showinfo("Do You want to calculate the denomination count?")
    if MsgBox=="ok":
        topwin()
